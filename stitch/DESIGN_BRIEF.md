...
- AuditTile Mini turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page tool called AuditTile Mini. It should show three metric tiles, a short activity list, one filter select, and a details panel. Use plain HTML, CSS, and JavaScript only, persist the selected filter in localStorage, and include clear empty and recovery states.
...
- Record Operations - AuditTile Mini
- Record Editor - AuditTile Mini
- Insights - AuditTile Mini
- Settings and Preferences - AuditTile Mini
- Empty and Error Recovery - AuditTile Mini

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - AuditTile Mini
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - AuditTile Mini
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - AuditTile Mini
...
SCREEN_SPEC_4:
- exact_screen_title: Settings and Preferences - AuditTile Mini
...
SCREEN_SPEC_5:
- exact_screen_title: Empty and Error Recovery - AuditTile Mini
